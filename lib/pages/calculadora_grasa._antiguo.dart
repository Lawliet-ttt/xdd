...
class PantallaCalculadoraGrasaAntiguo extends StatefulWidget {
  const PantallaCalculadoraGrasaAntiguo({super.key});

  @override
  State<PantallaCalculadoraGrasaAntiguo> createState() =>
      _PantallaCalculadoraGrasaAntiguoState();
}

class _PantallaCalculadoraGrasaAntiguoState extends State<PantallaCalculadoraGrasaAntiguo> {
